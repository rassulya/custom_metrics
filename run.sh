...
echo "=== Ansible Monitoring Stack Deployment ===" | tee "$LOG_FILE"
...
echo "- Grafana:    http://10.10.3.24:33330 (admin/monitoring123)" | tee -a "$LOG_FILE"
echo "- Prometheus: http://10.10.3.24:39090" | tee -a "$LOG_FILE"
echo "" | tee -a "$LOG_FILE"
echo "Exporter endpoints on slave_node_01:" | tee -a "$LOG_FILE"
echo "- GPU Process: http://10.6.254.75:9200/metrics" | tee -a "$LOG_FILE"
echo "- Disk Usage:  http://10.6.254.75:9201/metrics" | tee -a "$LOG_FILE"
echo "- Tmp Files:   http://10.6.254.75:9202/metrics" | tee -a "$LOG_FILE"
echo "- Node:        http://10.6.254.75:39100/metrics" | tee -a "$LOG_FILE"
